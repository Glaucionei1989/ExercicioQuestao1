...
namespace Questao1 {
    class Program {
        static void Main(string[] args) {
            ...
            Console.WriteLine($"Conta {conta.Numero}, Titular: {conta.Titular}, Saldo: {conta.DepositoInicial:C}");
            ...
            char respNome = char.Parse(Console.ReadLine());
            if (respNome == 's' || respNome == 'S')
            {
                Console.Write("Alterar o nome do titular da conta: ");
                titular = Console.ReadLine();
                conta.Update(titular);
                Console.WriteLine("Dados da conta atualizados:");
                Console.WriteLine($"Conta {conta.Numero}, Titular: {conta.Titular}, Saldo: {conta.DepositoInicial:C}");
            }
